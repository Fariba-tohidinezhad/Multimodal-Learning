...
from GIST_dataset_PooledCV import gist_dataloaders_pooled as gist_dataloaders  # returns (train, val, test)
...
def main():
    ...
    for tier in range(1, 10):
        ...
        for fold in folds:
            ...
            base_for_fold = merge_cfg(base_for_fold, {"fold": fold})
